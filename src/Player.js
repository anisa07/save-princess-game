import {initiateLifes} from './gameInfo';
...
class Player {
    ...
    create(x, y) {
        ...
        playerProps.setDead = false;
        initiateLifes(playerProps.lifes);
    }

    update() {
        if (this.player && !playerProps.isDead && this.cursorKeys) {
